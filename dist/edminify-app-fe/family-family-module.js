...
var FamilyViewGeneralComponent = /** @class */ (function () {
    ...
    FamilyViewGeneralComponent.prototype.getQueryParams = function () {
        var _this = this;
        this.familyQueryParamsService.familyQueryParams.subscribe(function (params) { return _this.params = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, params); });
    };
...
var FamilyPersonService = /** @class */ (function () {
    ...
    FamilyPersonService.prototype.add = function (data) {
        ...
        this.addOneRequest(data).subscribe(function (res) {
            ...
            _this._familyPersonList.next(Object.assign({}, _this.dataStore).familyPersonList);
            if (familyPerson.person_role === _this.familyRoles.student)
                _this.familyService.incrementFieldCount('students_count');
            if (familyPerson.person_role === _this.familyRoles.child)
    ...
    FamilyPersonService.prototype.delete = function (id, role) {
        var _this = this;
        this.deleteOneRequest(id).subscribe(function (data) {
            if (data.success) {
                _this.dataStore.familyPersonList.forEach(function (item, i) {
                    if (item.id == data.id) {
                        _this.dataStore.familyPersonList.splice(i, 1);
                    }
                });
                _this._familyPersonList.next(Object.assign({}, _this.dataStore).familyPersonList);
    ...
    FamilyPersonService.prototype.deleteOneRequest = function (id) {
        return this.http.delete("person/family/" + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res; }));
    };

...
import { mockSubmissionsListResponse } from './mock-api-responses';
...
export class FormManagementDataSource implements DataSource<any> {
  ...
  loadFormsList(params: FormSubmissionsListParams = { page: 0, limit: 10 }) {
    this.loadingSubject.next(true);
    const { data, ...metadata } = mockSubmissionsListResponse;

...
@Component({
  selector: 'sw-input-dash-checkbox',
  templateUrl: './input-dash-checkbox.component.html',
  styleUrls: ['./input-dash-checkbox.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class InputDashCheckboxComponent implements ControlValueAccessor {
  @Input() target = 'label';
  @Input()

...
@Component({
  ...
  templateUrl: './v-short-text-settings.component.html',
  styleUrls: ['./v-short-text-settings.component.css']
})
export class VShortTextSettingsComponent implements OnInit {

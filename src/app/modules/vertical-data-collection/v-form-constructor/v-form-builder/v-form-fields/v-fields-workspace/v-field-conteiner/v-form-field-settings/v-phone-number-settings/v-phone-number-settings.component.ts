...
@Component({
  ...
  templateUrl: './v-phone-number-settings.component.html',
  styleUrls: ['./v-phone-number-settings.component.css']
})
export class VPhoneNumberSettingsComponent implements OnInit {

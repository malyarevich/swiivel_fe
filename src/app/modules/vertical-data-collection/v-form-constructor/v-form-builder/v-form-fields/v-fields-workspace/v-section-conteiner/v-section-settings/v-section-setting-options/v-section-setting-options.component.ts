...
@Component({
  selector: 'app-v-section-setting-options',
  templateUrl: './v-section-setting-options.component.html',
  styleUrls: ['./v-section-setting-options.component.scss']
})
export class VSectionSettingOptionsComponent implements OnInit {
  @Input() section: Field;

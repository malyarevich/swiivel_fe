...
export abstract class DataEntity {
  public static defaultData: IData = {
    automation: AutomationEntity.defaultAutomation,
    publish_settings: PublishSettingsEntity.defaultPublishSettings
  };
}
...
export interface IData {
  publish_settings?: IPublishSettings;

...
import {Field, FieldSettingConditional} from "../../../../../../../../models/data-collection/field.model";
...
export class FieldsConditionalLogicComponent implements OnInit {
  ...
  constructor(private readonly fb: FormBuilder, private vFieldsService: FieldsService) {

...
storiesOf('Elements|User Item', module).addDecorator(withKnobs)
  ...
  .add('Default', () => {
    return {
      ...
      template: `
      <div class="story">
        <div class="title">User without avatar</div>
        <sw-user-item [userItem]="userWithoutAvatar" [isRoleShown]="showRole"></sw-user-item>
        <div class="title">User with avatar</div>
        <sw-user-item [userItem]="userWithAvatar" [isRoleShown]="showRole"></sw-user-item>
      </div>`,
      props: {
        userWithoutAvatar: object('userWithoutAvatar', {
            name: 'User Name',
            role: 'moderator',
          },
          'User Without Avatar'),
        userWithAvatar: object('userWithAvatar', {
            name: 'Brad Pitt',
            avatar,
            role: 'moderator',
          },
          'User Without Avatar'),
        showRole: boolean('showRole', true),
      }
    };
  })
  .add('Small', () => {
    return {
      ...
      <div class="story">
        <div class="title">User without avatar</div>
        <sw-user-item [userItem]="userWithoutAvatar" [isRoleShown]="showRole" [size]="size"></sw-user-item>
        <div class="title">User with avatar</div>
        <sw-user-item [userItem]="userWithAvatar" [isRoleShown]="showRole" [size]="size"></sw-user-item>
      </div>`,
      props: {
        userWithoutAvatar: object('userWithoutAvatar', {
            name: 'User Name',

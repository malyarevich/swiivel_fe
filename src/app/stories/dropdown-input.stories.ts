    ...
    return {
      template: `
        <div class="story">
          ...
          <div class="title">With Search Users</div>
          <div style="width: 20%">
            <sw-dropdown-input
              [options]="users"
              [search]="search"
      ...
      `,
      props: {
        options: object('options', [{value: 0, title: '1/4 page'}, {value: 1, title: '2/4 page'}, {value: 2, title: '3/4 page'}]),
        users: object('user', usersOptions),

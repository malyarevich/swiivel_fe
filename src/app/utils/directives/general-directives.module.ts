...
@NgModule({
    declarations: [ClickStopPropagationDirective, CustomMaxDirective, CustomMinDirective, NumbersValidatorDirective],
    exports: [ClickStopPropagationDirective, CustomMaxDirective, CustomMinDirective, NumbersValidatorDirective],
})
